...
var ProposalListComponent = /** @class */ (function () {
    function ProposalListComponent() {
        ...
        this.proposalTwo = new proposal_1.Proposal(60, 'This Company', 'http://portfolio.jordanhudgens.com', 'Ruby on Rails', 150, 120, 15, 'jordan@devcamp.com');
        this.proposalThree = new proposal_1.Proposal(20, 'Another Company', 'http://portfolio.jordanhudgens.com', 'Ruby on Rails', 150, 120, 15, 'jordan@devcamp.com');
        this.proposals = [
            this.proposalOne,
            this.proposalTwo,
            this.proposalThree
